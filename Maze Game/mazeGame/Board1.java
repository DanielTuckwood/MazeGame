...
public class Board1 extends JPanel implements ActionListener{
	...
	private class Al extends KeyAdapter {
		public void keyPressed(KeyEvent e) {
			...
			if (player.getSquareX() == 4 & player.getSquareY() == 5 & gold_found_1 != true) {
				gold_found_1 = true;
				Maze.wealth += 1;
			}
			if (player.getSquareX() == 18 & player.getSquareY() == 2 & gold_found_1 != true) {
				gold_found_1 = true;
				Maze.wealth += 1;
			}
			if (player.getSquareX() == 19 & player.getSquareY() == 19 & gold_found_1 != true) {
				gold_found_1 = true;
				Maze.wealth += 1;
			}
		}
